...
public class EmailGetBillsController {
    @FXML
    ...
    void onActionSend(ActionEvent event) {
        ...
        Thread thread=null;
        try {
            URL resource = getClass().getResource("/view/utilityBillsForm.fxml");
        ...
        if (isEmailOk) {
            try {
                Mail mail=new Mail("Your Bill Report Of Kalutara Post Office",emailTxtField.getText()," Bill Information","invoiceBill.pdf");
                mail.outMail();
