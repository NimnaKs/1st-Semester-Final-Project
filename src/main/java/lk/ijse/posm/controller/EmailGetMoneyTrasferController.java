...
public class EmailGetMoneyTrasferController {
    @FXML
    ...
    void onActionSend(ActionEvent event) {
        Thread thread=null;
        try {
            URL resource = getClass().getResource("/view/moneyTransferForm.fxml");
        ...
        if (isEmailOk) {
            try {
                Mail mail=new Mail("Your Money Transfer Bill Of Kalutara Post Office",emailTxtField.getText(),"Money Transfer Information","invoiceMoneyTrasfer.pdf");
                mail.outMail();
