...
public class GeneratePdf  {
    ...
    public void generateOrderReport(){
        ...
        tb.addCell(new Cell().add("All invoices for stationary items purchased at the Post Office are to be paid in full at the time of purchase. We accept cash, credit/debit cards, and other forms of payment as deemed acceptable by the Post Office.").setBorder(Border.NO_BORDER));
        document.add(tb);
