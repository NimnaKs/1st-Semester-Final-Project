...
public class GeneratePdfBill {
    ...
    private String bill_owners_name;

    private String refereneceNo;
    ...
    public void setBill_owners_name(String bill_owners_name) {
        this.bill_owners_name = bill_owners_name;
    }

    public void setRefereneceNo(String refereneceNo) {
        this.refereneceNo = refereneceNo;
    }
...
//        document.add(threeColTable3);
        ...
        twoColTable3.addCell(getCell10Left("Bill Type",true));
        twoColTable3.addCell(getCell10Left(bill_type,true));
        twoColTable3.addCell(getCell10Left("company Name",false));
        twoColTable3.addCell(getCell10Left(company_name+"",false));
        twoColTable3.addCell(getCell10Left("Bill Owners Name",true));
        twoColTable3.addCell(getCell10Left(bill_owners_name,true));
        twoColTable3.addCell(getCell10Left("Reference No",false));
        twoColTable3.addCell(getCell10Left(refereneceNo+"",false));
        twoColTable3.addCell(getCell10Left("Payment",false));
        twoColTable3.addCell(getCell10Left("Rs."+payment,false));
        ...
        tb.addCell(new Cell().add("All invoices for Bill service purchased at the Post Office are to be paid in full at the time of purchase. We accept cash, credit/debit cards, and other forms of payment as deemed acceptable by the Post Office.").setBorder(Border.NO_BORDER));
        document.add(tb);
